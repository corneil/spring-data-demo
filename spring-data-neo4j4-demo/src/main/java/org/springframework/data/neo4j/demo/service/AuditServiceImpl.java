...
import org.springframework.data.neo4j.demo.repository.AuditEntryRepository;
...
public class AuditServiceImpl implements AuditService {
    ...
    public List<AuditEntry> find(String auditType, Date startDate, Date endDate) {
        ...
        return repository.findByAuditTypeAndAuditTimeGreaterThanAndAuditTimeLessThanOrderByAuditTimeDesc(auditType, startDate, endDate);
    }
